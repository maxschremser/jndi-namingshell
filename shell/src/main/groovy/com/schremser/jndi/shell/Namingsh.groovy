...
class Namingsh extends Groovysh {
    ...
    private static final MessageSource messages = new MessageSource(Namingsh.class)
    ...
    def VERSION = "1.0";
    Context CURRENT_CONTEXT, INITIAL_CONTEXT;
    ...
    public String setPrompt(def newPrompt) {
        return prompt.render( newPrompt )
    }
